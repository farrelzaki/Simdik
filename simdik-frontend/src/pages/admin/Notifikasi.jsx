...
import { Bell, Filter, CheckCheck, AlertCircle, FileText, RefreshCw, Megaphone, Briefcase } from 'lucide-react'
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={marking}
            className="flex items-center gap-2 px-4 py-2 bg-[#1a4a6b] text-white rounded-xl text-sm hover:bg-[#15395a] disabled:opacity-60"
          >
                  ...
                  return (
                    <div
                      ...
                      className={`bg-white rounded-2xl shadow-sm p-5 flex gap-4 cursor-pointer hover:shadow-md transition-shadow
                        ${!item.dibaca ? 'border-l-4 border-[#1a4a6b]' : ''}`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {item.link && (
                          <div className="flex gap-2 mt-3">
                            <a
                              href={item.link}
                              className="px-3 py-1.5 bg-[#1a4a6b] text-white text-xs rounded-lg hover:bg-[#15395a]"
                            >
                              Lihat Detail
                            </a>
                          </div>
      ...
      {notifikasi.length > 0 && (
        <div className="text-center">
          <button className="text-sm text-[#1a4a6b] font-medium hover:underline">
